...
namespace KeyAuth
{
    public class api
    {
            ...
            else if (json.message == "invalidver")
            {
                ...
                switch (dialogResult)
                {
                    ...
                    case DialogResult.No:
                        ...
                        webClient.DownloadFile("", destFile);
        ...
        public string expirydaysleft()
        {
            ...
            {
                return Convert.ToString(difference.Hours + " Hours Left");
            }
            if (difference.Days >= 1)
            {
                return Convert.ToString(difference.Days + " Days Left");
            }
